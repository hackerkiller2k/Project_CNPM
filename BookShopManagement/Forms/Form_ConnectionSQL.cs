...
{
    public partial class Form_ConnectionSQL : Form
    {
        string str;
        public Form_ConnectionSQL()
        {
            InitializeComponent();
        }
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn chưa chọn CSDL ! ");
            }
            else
            {
        ...
        private void Form_ConnectionSQL_FormClosed(object sender, FormClosedEventArgs e)
        {
            //this.Close();
        }
        ...
        private void Form_ConnectionSQL_Load(object sender, EventArgs e)
        {
            btnTestConnection.Enabled = false;
            cmbAuthentication.Enabled = false;
